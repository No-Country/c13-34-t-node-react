    ...
    <div className="grid 2xl:grid-cols-2 2xl:gap-24 max-sm:pt-4 2xl:h-[620px] w-full">
      <div className="flex flex-col gap-2">
        <div className="flex flex-col w-full">
          <h1 className="font-caudex text-2xl 2xl:text-4xl font-bold pt-4 2xl:pt-14 mb-3 2xl:tracking-[1px]">
            "Donde una revisión clara se une a una atención compasiva."
          </h1>
          <p className="2xl:w-[600px] font-opensans 2xl:text-lg leading-1 pb-4 2xl:pb-20">
        ...
        <div className="p-5 2xl:w-full rounded-lg shadow-lg bg-white/70">
          <div className="grid grid-cols-1 2xl:grid-cols-3 gap-6 2xl:gap-12">
            <div className="2xl:col-span-2">
              <h3 className="text-dark-green font-bold text-xl 2xl:text-2xl mb-6 2xl:mb-12">
                Reservar una cita
              </h3>
              <div className="2xl:flex items-center gap-2 text-lg 2xl:text-lg">
            ...
            <div className="flex flex-col justify-center gap-4">
              <div>
                <p className="text-center pb-2 2xl:text-lg">Tienes una cuenta</p>
                <NavLink to="/acceso">
              ...
              <div>  
                <p className="text-center pb-2 2xl:text-lg">No tienes cuenta ?</p>
                <NavLink to="/registro">
